...
ENCUT = 115 ##eV
FFT_GCUT_MULT = 2.00 ##between 1 (a rough approximation) and 2 (100% match w/ naive multiplication)
...
#Get the spacings for the fft grids (unused ???)
...
#Compute H |psi>
actiondumb = dot(PSI_TRIAL, conj(hamil))
